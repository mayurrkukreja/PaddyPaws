...
<div class="container">
    <br>
        <div class="col-md-9">
            <div id="container" padding:100px;">
    ...
    <div class="bg-poster">
      ...
      <div class="right-poster">
        ...
        <div class="col-md-3" >
            ...
            <br>
                <div class="panel panel-default wow fadeInDown">
                    <div class="panel-heading wow fadeInDown" style="font-size:16px; font-weight:bold; color: #36648B;">Pet Certification</div>
                </div>

                    <div class="recent-work-wrap class="wow fadeInDown"">
                       
                            <div class="recent-work-inner">
                                <a class="preview wow fadeInDown" href="certificate.php"><br><span class="btn btn-success btm-sm pull-right">Get Certificate</span></a>
                            </div> 
                    </div>
                </div>  
        </div>
...
<footer id="footer" class="midnight-blue wow fadeInDown">
        <div class="container">
            <div class="row">
               ...
               &copy; 2021 <a target="_blank" href="#" title="#">PaddyPaws | Developed by Mayuri Kushwah</a>. All Rights Reserved (PaddyPaws).
                </div>
                <div class="col-sm-6">
